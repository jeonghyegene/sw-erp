...
(function () {
  ...
  /* ── 서류 본문 (신규입사자_정보등록.html 온보딩 서명 서류와 동일 내용) ── */
  const BODY_CONSENT = [
    '[ 서약서 ]',
    '',
    '상기 본인은 (주)성원애드피아(이하 "회사")에 입사함에 있어 아래의 사항에 대하여 서약하며, 본인의 고의 또는 과실로 서약사항을 성실히 이행하지 못하여 발생하는 민·형사상의 모든 책임을 질 것을 서약합니다.',
    '',
    '1. 본인은 회사 방침 및 제규정을 성실히 준수하고 상사의 업무상 지시명령에 복종하며, 거래처 및 고객의 주문사항을 성실히 이행하고 직원으로서의 품위·질서 유지에 어긋남이 없도록 근면성실히 근무하겠으며, 이를 위반하였을 때에는 회사규정에 따른 조치를 감수하겠습니다.',
    '2. 본인이 제출한 인사서류상 학력·경력 등 제반사항을 위조 또는 허위로 기재하였음이 발견되는 때에는 스스로 사직하고 어떠한 인사조치도 이의없이 따르겠습니다.',
    '3. 회사 또는 거래처의 업무상 지득한 영업비밀·기술정보(지적재산권 포함), 제조공정 등에 대해서 재직 중은 물론 퇴사 후에도 절대로 외부에 누설하지 않겠습니다.',
    '4. 고의 또는 중대한 과실로 회사의 인명과 재산에 손실을 끼친 때에는 지체없이 이를 배상하겠습니다.',
    '5. 재직 중 회사의 허가 없이는 자신을 위한 다른 사업을 하거나 회사와 관련되는 영업을 하지 않겠으며, 다른 직업에 종사하지 않겠습니다.',
    '',
    '[ 개인정보 수집·이용 동의서 ]',
    '',
    '상기 본인은 아래의 내용을 확인하고, ㈜성원애드피아(이하 "회사")가 다음과 같이 본인의 개인(신용)정보를 처리(수집·이용·제공 등)하는 것에 동의합니다.',
    '',
    'Ⅰ. 개인정보의 수집 및 이용',
    '· 수집 항목 : 성명·주소·연락처·이메일·생년월일, 병역·학력·자격·경력사항, 급여지급 계좌번호 등',
    '· 수집·이용 목적 : 근로자 명부 및 인사기록카드 작성, 교육·복리후생·급여관리·제증명 발급, 인사평가 등 제반 직원관리 업무',
    '· 보유·이용 기간 : 관계 법령에 별도 정함이 없는 한 수집·이용 목적을 달성할 때까지 보유·이용합니다.',
    '',
    'Ⅱ. 고유식별정보 및 민감정보',
    '주민등록번호, 건강검진결과 내역서 등에 대한 수집·이용에 동의합니다.',
    '',
    '본인은 회사의 개인정보 수집·이용 및 제3자 제공에 관한 설명을 모두 이해하였고, 이에 동의합니다.',
  ].join('\n');

  const BODY_SECURITY = [
    '[ 기밀 준수 및 경업금지 서약서 ]',
    '',
    '본인은 ㈜성원애드피아(이하 "회사")와 근로계약을 체결한 후 회사의 임직원으로 근무하고 있는바, 회사의 영업비밀을 준수하고 경업금지를 하는 데 있어 본인의 자유로운 의사로써 다음과 같이 서약합니다. 아울러 본 서약서가 근무기간뿐 아니라 퇴직 후에도 일정기간 적용될 수 있음을 인식하고 서약합니다.',
    '',
    '1. 영업비밀의 준수',
    '① 본인이 회사에 재직 중 업무수행상 또는 업무와 관계없이 취득한, 비밀로 관리된 회사의 정보 및 영업활동에 유용한 기술상·경영상의 정보를 회사의 사전 서면 동의 없이는 은닉·사용하거나 제3자에게 누설·공개하지 않겠습니다.',
    '② 재직 중 영업비밀과 관련하여 발명·개발·고안한 산출물에 관한 일체의 권리는 회사에 있음을 인정하며, 퇴직 이후에도 사전 서면 동의 없이는 이를 이용·누설·공개하지 않겠습니다.',
    '③ 회사로부터 제공받은 정보자산(서류·전자파일·저장매체·전산장비 등)을 무단 보관·복사·훼손하지 않고 안전하게 관리하며, 업무 종료 시 지체없이 반환하겠습니다.',
    '④ 본인에게 할당된 사용자 ID·패스워드·출입증을 타인과 공동사용하거나 제3자에게 누설하지 않겠습니다.',
    '⑤ 재직 중은 물론 퇴사 후에도 회사의 영업비밀보호규정을 비롯한 보안정책 관련 지침과 직무상의 명령을 준수하겠습니다.',
    '',
    '2. 타사 영업비밀 침해 금지',
    '재직 중 다른 회사의 영업비밀을 부정한 방법으로 취득하지 않으며, 이전 직장의 영업비밀을 회사에 공개하거나 회사 업무에 사용하지 않겠습니다.',
    '',
    '3. 경업금지',
    '회사의 영업비밀 보호를 위하여, 적어도 퇴직일로부터 1년 동안 회사의 사전 서면 동의 없이는 회사와 동일·유사한 제품을 생산하는 업체를 창업하거나 그러한 업체에 취업하지 않겠습니다.',
    '',
    '4. 서약서의 효력',
    '본 서약서는 본인이 서명함과 동시에 효력을 발생하며 퇴직 후에도 효력을 유지합니다. 상기 사항을 모두 확인·숙지하고 이를 성실히 준수할 것을 서약합니다.',
  ].join('\n');

  const BODY_SAFETY = [
    '[ 안전 준수 서약서 ]',
    '',
    '본인은 ㈜성원애드피아(이하 "회사")에서 회사의 팀장·파트장으로서 업무를 수행하는 사람으로서 아래의 사항을 성실히 준수할 것을 서약합니다.',
    '',
    '[ 아 래 ]',
    '',
    '1. 작업 중 장비 운영 및 작업자에 대한 안전관리를 철저히 하겠습니다.',
    '2. 작업 중 작업자가 안전관리 규정을 철저히 준수하도록 감독하고, 작업장 내 안전사고 발생을 사전에 방지하도록 안전에 필요한 교육도 하겠습니다.',
    '3. 기계의 작동 중 정비·수리 및 청소를 하지 않으며, 반드시 작동을 멈춘 후 작업하도록 하겠습니다.',
    '',
    '나는 상기 사항을 숙지하고 성실히 준수할 것을 서약하며, 위반하였을 경우 회사 규정에 따른 징계조치 등 어떠한 합당한 처벌도 감수할 것을 서약합니다. 또한, 소속 작업자의 재해 발생 시 관리소홀에 대한 연대책임도 지겠습니다.',
  ].join('\n');

  const REGISTRY = (App.JoinDocsRegistry = App.JoinDocsRegistry || {
    ALL_EMP_TAGS,
    docs: [
      { key: 'sec',    name: '근무 보안 서약서',            targetTags: ALL_EMP_TAGS.slice(),  effectiveFrom: 'all', activeVersion: 'v1', versions: [{ v: 'v1', publishedAt: '2026-01-01', changeReason: '최초 등록', policy: null }], body: BODY_SECURITY },
      { key: 'priv',   name: '입사 동의서류',              targetTags: ALL_EMP_TAGS.slice(),  effectiveFrom: 'all', activeVersion: 'v1', versions: [{ v: 'v1', publishedAt: '2026-01-01', changeReason: '최초 등록', policy: null }], body: BODY_CONSENT },
      ...
      { key: 'safety', name: '안전 준수 서약서',             targetTags: ['생산직'],            effectiveFrom: 'all', activeVersion: 'v1', versions: [{ v: 'v1', publishedAt: '2026-01-01', changeReason: '최초 등록', policy: null }], body: BODY_SAFETY },
