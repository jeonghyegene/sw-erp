...
- 현재 버전: **v1.8 (2026-08-06)** — 원본 정책서와 동일하게 관리합니다.
- 버전 표기 위치: 상단 네비 드롭다운(`v1.8`) · 하단 푸터 · 홈 히어로 · [변경 이력](./changelog.md).
- 버전을 올릴 때 함께 수정할 곳:
...
- 현재 단일 진실원은 **`documents/성원애드피아_ERP_인사근태급여_통합정책서_v1.8.md`** 입니다. (v1.7 이하 및 v1.0 원본 `성원애드피아_ERP_인사근태급여_통합정책서.md` 는 아카이브로 보존)
